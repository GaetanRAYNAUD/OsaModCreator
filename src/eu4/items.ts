import {
  DescriptorFile, Eu4File, Eu4FileList, Eu4Folder, TechnologyGroupsFile, TradeNodeFile, TradeNodesFolder, UnitFile,
  UnitsFolder,
} from '@eu4/folders.ts';
...
export const itemCategories: ItemCategory[] = [
  ...
  },
  {
    ...
    items: [{
      ...
      folder: TradeNodesFolder,
      fileProvider: TradeNodeFile,
    }, {
