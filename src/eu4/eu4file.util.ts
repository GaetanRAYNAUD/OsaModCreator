...
export function readFile(file: string): ReturnType<Query['root']> {
  return jomini.parseText(file);
}

export function readFileEncoding(file: File, encoding: string): Promise<string> {
